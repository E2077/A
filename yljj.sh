...
alpine_pkgs="libffi-dev no-cache"
py_reqs="pip requests jieba setuptools PyExecJS"
js_pkgs="axios	fs js-yaml crypto	dotenv yargs ts-md5 tslib typescript require crypto-js png-js iconv-lite js-base64 canvas date-fns ts-node moment"
pl_mods=" "
